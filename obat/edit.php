    ...
    <div class="container">
        ...
        <div class="col-6 m-auto">
            <form method="POST" action="edit.php">
                ...
                global $conn;
                $kode = $_GET["kode"];
                $query = "SELECT * FROM obat WHERE kode='$kode'";
                ...
                while ($data = mysqli_fetch_object($result)) :
                    ...
                    <div class="form-group">
                        ...
                        <input name="kodeobat" type="text" class="form-control" value="<?= $data->kode ?>" readonly>
                    </div>
                    <div class="form-group">
                        <label for="">Nama Obat</label>
                        <input name="namaobat" type="text" class="form-control" value="<?= $data->nama_obat ?>">
                    </div>
                    <div class="form-group">
                        <label for="">jenis obat</label>
                        <select name="jenisobat" class="form-control" value="<?= $data->jenis_obat ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input name="hargabeli" type="number" class="form-control" value="<?= $data->harga_beli ?>">
                    </div>
                    <div class="form-group">
                        <label for="">harga jual</label>
                        <input name="hargajual" type="number" class="form-control" value="<?= $data->harga_jual ?>">
                    </div>
                    <div class="form-group">
                        <label for="">Expired</label>
                        <input name="expired" type="date" class="form-control" value="<?= $data->expired ?>">
                    </div>
                    <div class="form-group">
