<?php
include "../Apotek/koneksi/koneksi.php";
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-2  col-md-3">
                            <div class="card">
                                <img src="img/Apotek-Toko-Obat.jpg" class="card-img-top" alt="apotek">
                                <div class="card-body">
                        ...
                        <div class="col-sm-2 col-md-3">
                            <div class="card">
                                <img src="img/apotek2.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">Special title treatment</h5>
                                    <p class="card-text">With supporting text below as a natural lead-in to additional
                                        content.</p>
                        ...
                        <div class="col-sm-2 col-md-3">
                            <div class="card">
                                <img src="img/apotek obat 3.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">Special title treatment</h5>
                                    <p class="card-text">With supporting text below as a natural lead-in to additional
                                        content.</p>
